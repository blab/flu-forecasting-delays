...
We tested the effect of forecasting future influenza populations at forecast horizons of 3, 6, 9, and 12 months (Figure~\ref{fig:model_of_delays_and_horizons}B).
...
This experimental design produced forecasts for three delay types at each of the four forecast horizons (e.g., Figure~\ref{fig:model_of_delays_and_horizons}B, blue, green, and orange initial timepoints for the 3-month forecast horizon).
...
To simplify the data required for these analyses, we produced forecasts of natural A/H3N2 populations with our best sequence-only model from our prior work, the local branching index (LBI) and mutational load model \citep{Huddleston2020}.
