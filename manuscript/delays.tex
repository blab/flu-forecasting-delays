...
The majority of forecast frequency errors for small clades appeared to be normally distributed around plus or minus 10\% (\FIG{h3n2_forecast_clade_frequency_errors}).
...
We observed a long tail of clades with underestimated future frequencies at all forecast horizons.
Each 3-month reduction of the forecast horizon linearly reduced the extent of overestimated small clades.
Reducing the forecast horizon only reduced the extent of underestimated small clades at the 6- and 3-month horizons.
In contrast, reducing submission delays had no effect on forecast errors for these small clades.

Forecast frequency errors for large clades were also normally distributed without a consistent bias toward under- or overestimation (\FIG{h3n2_forecast_clade_frequency_errors}).
As with small clades, each 3-month reduction in forecast horizon reduced the degree to which the forecasts overestimated large clades.
However, the most extreme cases of underestimation under realistic delays persisted at all forecast horizons above 3 months.
Reducing submission delays consistently reduced the range of forecast errors.
