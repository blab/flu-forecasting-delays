...
Delays also induced a bias toward underestimation of large clade frequencies with a mean and median error of 1\% under ideal delays and 3\% under realistic delays (\FIGSUPP[h3n2_current_clade_frequency_errors]{simulated_current_clade_frequency_errors}D).
