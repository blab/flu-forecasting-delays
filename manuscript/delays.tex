...
Both interventions with improved vaccine development increased forecast accuracy for the majority of future timepoints (\FIG{h3n2_effects_of_realistic_interventions}, \TABLE{h3n2_effects_of_realistic_interventions}, and \FIGSUPP[h3n2_effects_of_realistic_interventions]{h3n2_total_absolute_forecast_frequency_errors_by_delay_and_horizon}).
In contrast, the intervention that only improved genomic surveillance slightly increased forecast error by an average of 3\%.
Improving vaccine development alone reduced total forecast error by 25\% on average, while the addition of improved genomic surveillance under that 6-month forecast horizon reduced total forecast error by 27\% on average.
