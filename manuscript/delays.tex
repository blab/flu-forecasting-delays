...
{\includegraphics[width=6cm]{figures/sequences_per_region}}\label{figsupp:sequences_per_region}
%
...
{Optimal distance to the future per timepoint (AAs) for natural A/H3N2 populations by forecast horizon and submission lag type based on posthoc empirical fitness of the initial population. \figsuppdata{Optimal distance to the future for natural A/H3N2 populations; see \texttt{h3n2\_distances\_to\_the\_future.csv} at \url{https://doi.org/10.5281/zenodo.17259448}.}}
...
{Optimal distance to the future per timepoint (AAs) for simulated A/H3N2-like populations by forecast horizon and submission lag type based on posthoc empirical fitness of the initial population. \figsuppdata{Optimal distance to the future for simulated A/H3N2-like populations; see \texttt{simulated\_distances\_to\_the\_future.csv} at \url{https://doi.org/10.5281/zenodo.17259448}.}}
...
{\includegraphics[width=6cm]{figures/h3n2_high_density_optimal_effects_of_realistic_interventions_on_distances_to_the_future}}\label{figsupp:h3n2_high_density_optimal_effects_of_realistic_interventions_on_distances_to_the_future}
%
...
{\includegraphics[width=6cm]{figures/h3n2_optimal_effects_of_realistic_interventions_on_distances_to_the_future_by_future_clade_entropy}}\label{figsupp:h3n2_optimal_effects_of_realistic_interventions_on_distances_to_the_future_by_future_clade_entropy}
%
...
{\includegraphics[width=6cm]{figures/h3n2_optimal_effects_of_realistic_interventions_on_distances_to_the_future_by_hemisphere}}\label{figsupp:h3n2_optimal_effects_of_realistic_interventions_on_distances_to_the_future_by_hemisphere}
%
