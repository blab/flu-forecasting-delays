...
In contrast, the standard deviation at the 12-month horizon under ideal submission delays did not change from the realistic delays at 31\%.
For all other forecast horizons, reducing the submission delays from realistic to ideal only reduced the standard deviation by 1--2\%.
