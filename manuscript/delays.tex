...
For both populations, we also calculated the optimal distance between initial and future populations based on posthoc empirical fitness of the initial population.
...
From this work, we know that our current frequency estimates for large clades ($>$10\% frequency) under realistic submission delays have a wide range of errors (-16\% to 29\%).
