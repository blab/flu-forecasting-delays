...
{Distance to the future per timepoint (AAs) for simulated H3N2-like populations by forecast horizon and submission delay type based on forecasts from the ``true fitness'' model.
...
%
\figsupp[Improvement of optimal distances to the future (AAs) for H3N2 populations between the status quo (12-month forecast horizon and realistic submission delays) and realistic interventions.]
{Improvement of optimal distances to the future (AAs) for H3N2 populations between the status quo (12-month forecast horizon and realistic submission delays) and realistic interventions.\
  \figsuppdata{Improvement of optimal distances to the future per future timepoint for H3N2 populations; see \url{https://doi.org/xxx}}}
...
%
\figsupp[Improvement of optimal distances to the future (AAs) for simulated H3N2-like populations between the status quo (12-month forecast horizon and realistic submission delays) and realistic interventions.]
{Improvement of optimal distances to the future (AAs) for simulated H3N2-like populations between the status quo (12-month forecast horizon and realistic submission delays) and realistic interventions.\
  \figsuppdata{Improvement of optimal distances to the future per future timepoint for simulated H3N2-like populations; see \url{https://doi.org/xxx}}}
...
\begin{table}[htb]
  \begin{center}
    ...
    \caption{Improvement in H3N2 clade frequency forecast accuracy under realistic interventions of improved vaccine development (reducing 12-month to 6-month forecast horizon), improved surveillance (reducing submission delays from 3 months on average to 1 month), or a combination of both interventions.
...
We hypothesized that the decrease in average accuracy of natural H3N2 forecasts under the improved genomic surveillance intervention could reflect the bias of the LBI and mutational load fitness metrics.
For example, if LBI fitness estimates tend to overestimate the future growth of large clades, adding more sequences at any timepoint could increase the LBI and exacerbate the overestimation.
...
For natural H3N2 populations, the average improvement of the vaccine intervention was 1.1 AAs and the improvement of the surveillance intervention was 0.27 AAs or approximately 25\% of the vaccine intervention.
