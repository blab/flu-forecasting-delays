...
% What we learned about submission delays
% What we learned about forecast horizons
...
% Start now to forecast to start of the next season (9 months) instead of the middle of the season (12 months)
% Start forecasting from an initial timepoint in the past, to minimize current clade frequency error associated with submission delays.
