...
Of the 822 clades under the scenario without delays, 374 (45\%) had a frequency less than 1\% below the threshold that we could consider for forecasting.
Another 361 clades (44\%) had a frequency greater than 1\% but less than 10\%, while the remaining 87 (11\%) had a frequency of 10\% or greater.
...
For small clades ($\ge$1\% and $<$10\% frequency), errors under ideal delays ranged from -3\% to 4\% with a standard deviation of 1\%, while realistic delays produced errors ranging from -8\% to 7\% with a standard deviation of 2\% (\FIG{h3n2_current_clade_frequency_errors}C).
