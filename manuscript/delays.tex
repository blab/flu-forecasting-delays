...
%%% ARTICLE SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Timely vaccine strain selection and genomic surveillance improve evolutionary forecast accuracy of seasonal influenza A/H3N2}
...
The lag between collection of a clinical sample and public availability of its sequence averages $\sim$3 months, complicating the 12-month forecasting problem by reducing our understanding of current clade frequencies.
...
Sequence data are available from the GISAID EpiFlu Database using accessions provided in Supplementary File 1.
...
\textbf{Supplementary File 1.} GISAID accessions and metadata including originating and submitting labs for natural strains used across all timepoints.
