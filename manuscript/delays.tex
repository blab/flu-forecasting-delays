...
For example, virus samples from North America and Europe are overrepresented in the GISAID EpiFlu database, while samples from Africa and Asia are underrepresented \citep{McCarron2022}.
...
With this subsampling approach, we selected between 7\% (Europe) and 91\% (Southeast Asia) of all available sequences per region across the entire study period with an average of 50\% and median of 52\% across all 10 regions.
