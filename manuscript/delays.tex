...
However, the average delay between collection of a hemagglutinin sequence and submission to the Global Initiative on Sharing All Influenza Data (GISAID) database is 3 months.
...
While these models continue to improve technically \citep{Meijers2023}, the constraints of a 12-month forecast horizon and the availability of enough representative HA sequences in GISAID impose an upper bound on the accuracy of long-term forecasts.

The global response to the SARS-CoV-2 pandemic in 2020 showed the speed with which we could develop new vaccines and capture real-time viral genetic diversity.
Decades of research on mRNA vaccines led to the rapid development of multiple effective SARS-CoV-2 vaccines \citep{Mulligan2020,Baden2021}.
This mRNA-based vaccine platform also enabled the development of Omicron-based boosters only 3 months after the choice of a new vaccine candidate \citep{Grant2023}.
Advances in vaccine development and genomic surveillance since SC2 pandemic
\citep{Wong2013} (flu vaccines including mRNA)
\citep{Kalia2021}, lag in submission of SC2
\citep{Brito2022}, reduced lag in submission of SC2 by region
\citep{Chen2022}, capacity building
\citep{Abousamra2023}, effects of submission delays on frequency estimates and short term forecasts

Test effects of similar improvements for H3N2 with a previously validated long-term forecasting model using simulated and natural populations, performing comparisons of relative improvement within each model as a proxy for improvement across models
