...
\figdata{Distribution of lags between sample collection and sequence submission in prepandemic and pandemic eras.}\label{figdata:distribution_of_submission_lags}
\end{figure}
...
{Distance to the future per timepoint (AAs) for simulated A/H3N2-like populations by forecast horizon and submission lag type based on forecasts from the ``true fitness'' model.
  \figsuppdata{Distances to the future for simulated A/H3N2-like populations; see \url{https://doi.org/xxx}}}
...
{Clade frequency errors between simulated A/H3N2-like HA populations with ideal or realistic submission lags and populations without any submission lag.
  \figsuppdata{Current and future clade frequencies for simulated A/H3N2-like populations by forecast horizon and submission lag type; see \url{https://doi.org/xxx}}}
...
{Improvement of clade frequency errors for simulated A/H3N2-like populations between the status quo and realistic interventions.
  \figsuppdata{Differences in total absolute clade frequency error per future timepoint and clade between the status quo and realistic interventions for simulated A/H3N2-like populations; see \url{https://doi.org/xxx}}}
