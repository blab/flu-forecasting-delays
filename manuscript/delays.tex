...
While long-term forecasting models continue to improve technically \citep{Meijers2023}, the constraints of a 12-month forecast horizon and the availability of enough representative HA sequences in GISAID impose an upper bound on the accuracy of long-term forecasts.
...
A switch from the current egg-based inactivated virus vaccines to mRNA vaccines could reduce the time between vaccine design decisions and the peak influenza season from 12 months to 3 months.
...
We quantified the improvement in forecasting accuracy based on the genetic distances between and clade frequencies of estimated and observed future populations.
We also quantified the effect of reduced submission delays on estimates of current clade frequencies.
